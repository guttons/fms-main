...
const OPERATIONS_LOG_SCHEMA: TableSchema = {
  fields: [
    ...
    { name: 'std',                  type: 'STRING',    mode: 'NULLABLE'  },
    { name: 'tobt',                 type: 'STRING',    mode: 'NULLABLE'  },
    { name: 'frt_airline',          type: 'STRING',    mode: 'NULLABLE'  },
    { name: 'frt_aocc',             type: 'STRING',    mode: 'NULLABLE'  },
    { name: 'frt_for',              type: 'STRING',    mode: 'NULLABLE'  },
    { name: 'remarks',              type: 'STRING',    mode: 'NULLABLE'  },
...
function rowToLog(row: Record<string, any>) {
  ...
  return {
    ...
    std:                 row.std ?? null,
    tobt:                row.tobt ?? null,
    frtAirline:          row.frt_airline ?? null,
    frtAocc:             row.frt_aocc ?? null,
    frtFor:              row.frt_for ?? null,
    remarks:             row.remarks,
...
function logToRow(log: Record<string, any>, id: string): Record<string, any> {
  ...
  return {
    ...
    std:                   log.std                 ?? null,
    tobt:                  log.tobt                ?? null,
    frt_airline:           log.frtAirline          ?? null,
    frt_aocc:              log.frtAocc             ?? null,
    frt_for:               log.frtFor              ?? null,
