...
export const BottomNav: React.FC<BottomNavProps> = ({ 
  ...
  return (
    <div className={`fixed bottom-6 left-0 right-0 mx-auto w-[calc(100%-48px)] bg-surface border border-outline/35 lg:hidden z-50 px-4 rounded-[32px] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.6),0_0_20px_rgba(0,0,0,0.2)] transition-[transform,opacity,visibility] duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] ${
